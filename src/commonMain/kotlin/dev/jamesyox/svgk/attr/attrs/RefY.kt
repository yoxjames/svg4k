...
import dev.jamesyox.svgk.tags.Symbol
 ...
 * `y` attribute and any transformations on the [Symbol] and its host [dev.jamesyox.svgk.tags.Use] element.
 *
...
/**
 * Unsafe version of RefY. Functionality depends on what [dev.jamesyox.svgk.SvgTag] is the parent.
 */
context(
    ac: AttributeConsumer,
