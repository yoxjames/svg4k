 ...
 *
 * The [textAnchor] attribute is applied to each individual text chunk within a given [dev.jamesyox.svg4k.tags.Text]
 ...
 * [dev.jamesyox.svg4k.tags.Text] element, any [x] or [y] attribute values on a [dev.jamesyox.svg4k.tags.Tspan]
 * element assigned explicitly to the first rendered character in a text chunk, or determination of the initial
 * current text position for a [dev.jamesyox.svg4k.tags.textPath] element.
 */
context(
