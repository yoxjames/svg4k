 ...
 * [dev.jamesyox.svgk.tags.Mask] element when masking.
 */
context(
...
public enum class MaskType(
    ...
    /**
     * This value indicates that the [dev.jamesyox.svgk.tags.Mask] element's alpha values should be used; the pixels
    ...
    /**
     * This value indicates that the [dev.jamesyox.svgk.tags.Mask] element's luminance values should be used; the
