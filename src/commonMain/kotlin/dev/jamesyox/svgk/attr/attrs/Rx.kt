...
import dev.jamesyox.svgk.tags.Ellipse
...
/**
 * For [dev.jamesyox.svgk.tags.Rect], [rx] defines the x-axis radius of the ellipse used to round off the
...
/**
 * Unsafe version of [rx]. Functionality depends on what [dev.jamesyox.svgk.SvgTag] is the parent.
 */
context(
    ac: AttributeConsumer,
