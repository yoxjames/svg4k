 ...
 * the shape. It applies to any SVG shape or [dev.jamesyox.svgk.tags.categories.category.TextContentElement],
 * but as an inherited property, it may be applied to elements such as [dev.jamesyox.svgk.tags.G] and still
