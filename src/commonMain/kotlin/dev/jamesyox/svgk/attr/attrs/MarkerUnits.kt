 ...
 * the contents of the [dev.jamesyox.svgk.tags.Marker].
 */
context(
...
public enum class MarkerUnits(
     ...
     * [dev.jamesyox.svgk.tags.Marker] element represent values in the current user coordinate system in place for the
     * graphic object referencing the marker (i.e., the user coordinate system for the element referencing the
     * [dev.jamesyox.svgk.tags.Marker] element via a [markerStart], [markerMid], or [markerEnd] property).
     */
    UserSpaceOnUse("userSpaceOnUse"),

    /**
     * This value specifies that the [markerWidth] and [markerHeight] attributes and the contents of the
     * [dev.jamesyox.svgk.tags.Marker] element represent values in a coordinate system which has a single unit equal
