 ...
 *
 *  * For [dev.jamesyox.svgk.tags.FeSpotLight], [specularExponent] defines the exponent value controlling the focus
 * for the light source.
 *  * For [dev.jamesyox.svgk.tags.FeSpecularLighting], [specularExponent] defines the exponent value for
 *  the specular term.
 */
context(
